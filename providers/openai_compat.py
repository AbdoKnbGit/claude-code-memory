...
class OpenAICompatibleProvider(BaseProvider):
    ...
    async def _stream_response_impl(
                ...
                async for chunk in stream:
                    ...
                    if delta.tool_calls:
                        ...
                        for tc in delta.tool_calls:
                            tc_info = {
                                "index": tc.index if isinstance(tc.index, int) else 0,
                                "id": tc.id,
                                "function": {
        ...
        output_tokens = (
            ...
            if usage_info
            and hasattr(usage_info, "completion_tokens")
            and isinstance(usage_info.completion_tokens, int)
...
class OpenAIProvider(OpenAICompatibleProvider):
    ...
    def _build_request_body(self, request: Any) -> dict:
        """Internal helper to convert Anthropic request into OpenAI body."""
